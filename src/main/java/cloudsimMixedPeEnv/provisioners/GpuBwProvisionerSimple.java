package cloudsimMixedPeEnv.provisioners;
...
public class GpuBwProvisionerSimple extends GpuBwProvisioner {
	 ...
	 * 
	 * @see
	 * cloudsimMixedPeEnv.provisioners.GpuBwProvisioner#allocateBwForVgpu
	 * (cloudsimMixedPeEnv.Vgpu, long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsimMixedPeEnv.provisioners.GpuBwProvisioner#isSuitableForVm
	 * (cloudsimMixedPeEnv.Vgpu, long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsimMixedPeEnv.provisioners.GpuBwProvisioner#getAvailableBw()
	 */
	@Override
