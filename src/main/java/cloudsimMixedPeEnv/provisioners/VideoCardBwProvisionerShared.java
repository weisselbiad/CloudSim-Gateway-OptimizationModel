...
public class VideoCardBwProvisionerShared extends VideoCardBwProvisioner {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsimMixedPeEnv.provisioners.VideoCardBwProvisioner#
	 * allocateBwForPgpu(cloudsimMixedPeEnv.Pgpu, long)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * cloudsimMixedPeEnv.provisioners.VideoCardBwProvisioner#getAvailableBw(
	 * )
	 */
	@Override
