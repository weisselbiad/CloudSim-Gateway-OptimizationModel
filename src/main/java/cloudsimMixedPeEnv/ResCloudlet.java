...
public class ResCloudlet {
	 ...
	 * @post $none
	 */
	public ResCloudlet(CloudSim cloudsim, Cloudlet cloudlet) {
	 ...
	 * @post $none
	 */
	public ResCloudlet(CloudSim cloudsim, Cloudlet cloudlet, long startTime, int duration, int reservID) {
		this.cloudsim = cloudsim;
		this.cloudlet = cloudlet;
