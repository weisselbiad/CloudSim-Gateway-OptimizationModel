 ...
 */
public abstract class BrokerAbstract extends CloudSimEntity implements DatacenterBroker {
    /**
     ...
     */
    public BrokerAbstract(final CloudSim simulation, final String name) {
        super(simulation);
        if(!name.isEmpty()) {
            setName(name);
        }
    ...
    protected abstract Vm MyVmMapper(Cloudlet cloudlet);
