...
public class CloudletsTableBuilder extends TableBuilderAbstract<Cloudlet> {
    ...
    protected void createTableColumns() {
        ...
        addColumnDataFunction(getTable().addColumn("Host Type", "Class  name"), cloudlet -> ClassToString(cloudlet.getVm().getHost().getClass().toString()));
        ...
        addColumnDataFunction(getTable().addColumn("VM Type", "Class  name"), cloudlet -> ClassToString(cloudlet.getVm().getClass().toString()));
    ...
    private String ClassToString(String X){
        String classStr = null;
        switch (X){
            case "class org.cloudbus.cloudsim.cloudlets.CloudletSimple": classStr="CloudletSimple";
                break;
            case "class cloudsimMixedPeEnv.GpuCloudlet": classStr="GpuCloudlet";
                break;
            case "class org.cloudbus.cloudsim.hosts.HostSimple": classStr="HostSimple";
                break;
            case "class cloudsimMixedPeEnv.GpuHost": classStr = "GpuHost";
                break;
            case "class org.cloudbus.cloudsim.vms.VmSimple": classStr ="VmSimple";
                break;
            case "class cloudsimMixedPeEnv.GpuVm":classStr="GpuVm";
                break;
            default: classStr = "Invalid Class";
                break;
        }
        return classStr;
    }
