...
import cloudsimMixedPeEnv.BusTags;
import cloudsimMixedPeEnv.GpuTaskScheduler;
...
public class GridVgpuTags {
	 ...
	 */
	public static Vgpu getK180Q(CloudSim simulation, int vgpuId, GpuTaskScheduler scheduler) {
		...
		Vgpu vgpu = new Vgpu(simulation,vgpuId, mips, numberOfPes, gddram, bw, type, DONT_CARE, scheduler, BusTags.PCI_E_3_X16_BW);
		return vgpu;
	}
	 ...
	 */
	public static Vgpu getK160Q(CloudSim simulation, int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 * @return a K140Q virtual GPU
	 */
	public static Vgpu getK140Q(CloudSim simulation, int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 */
	public static Vgpu getK120Q(CloudSim simulation,int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 */
	public static Vgpu getK220Q(CloudSim simulation,int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 */
	public static Vgpu getK240Q(CloudSim simulation,int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 */
	public static Vgpu getK260Q(CloudSim simulation,int vgpuId, GpuTaskScheduler scheduler) {
	 ...
	 */
	public static Vgpu getK280Q(CloudSim simulation,int vgpuId, GpuTaskScheduler scheduler) {
