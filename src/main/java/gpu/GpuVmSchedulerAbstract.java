 ...
 */
    ...
    public abstract class GpuVmSchedulerAbstract implements VmScheduler {
        ...
        private Map<String, List<GpuPe>> peMap;
         ...
         * @post $none
         */
        public GpuVmSchedulerAbstract(List<? extends GpuPe> pelist) {
            setPeList(pelist);
            setPeMap(new HashMap<String, List<GpuPe>>());
         ...
         * @post $none
         */
        public abstract boolean allocatePesForVm(GpuVm vm, List<Double> mipsShare);
         ...
         * @post $none
         */
        public abstract void deallocatePesForVm(GpuVm vm);
         ...
         */
        public List<GpuPe> getPesAllocatedForVM(GpuVm vm) {
        ...
        public <T extends GpuPe> List<T> getPeList() {
         ...
         */
        protected <T extends GpuPe> void setPeList(List<T> peList) {
            this.peList = peList;
        }
         ...
         * @return the pe map
         */
        public Map<String, List<GpuPe>> getPeMap() {
            return peMap;
        }
         ...
         */
        protected void setPeMap(Map<String, List<GpuPe>> peMap) {
            this.peMap = peMap;
        }
