...
public class GpuVmSchedulerTimeShared extends GpuVmSchedulerAbstract {
     ...
     */
    public GpuVmSchedulerTimeShared(List<? extends GpuPe> pelist) {
        super(pelist);
        setMipsMapRequested(new HashMap<String, List<Double>>());
    }

    @Override
    public boolean allocatePesForVm(GpuVm vm, List<Double> mipsShareRequested) {
        /*
