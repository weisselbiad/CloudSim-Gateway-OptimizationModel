...
import java.util.List;
   ...
   /**
     ...
     */
    public class GpuDatacenterCharacteristics {
        ...
        private List<? extends GpuHost> hostList;
         ...
         * @post $none
         */
        public GpuDatacenterCharacteristics(
                String architecture,
                String os,
                String vmm,
                List<? extends GpuHost> hostList,
                double timeZone,
                double costPerSec,
                double costPerMem,
         ...
         * @post $none
         */
        public GpuHost getHostWithFreePe() {
         ...
         * @post $none
         */
        public GpuHost getHostWithFreePe(int peNumber) {
        ...
        public <T extends GpuHost> List<T> getHostList() {
         ...
         */
        protected <T extends GpuHost> void setHostList(List<T> hostList) {
