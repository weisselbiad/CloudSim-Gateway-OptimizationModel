...
public class RamProvisionerSimple extends RamProvisioner {
    ...
    @Override
    public boolean allocateRamForVm(GpuVm vm, int ram) {
        int maxRam = (int)vm.getRam().getCapacity();
    ...
    @Override
    public int getAllocatedRamForVm(GpuVm vm) {
    ...
    @Override
    public void deallocateRamForVm(GpuVm vm) {
        if (getRamTable().containsKey(vm.getUid())) {
    ...
    @Override
    public boolean isSuitableForVm(GpuVm vm, int ram) {
