...
import gpu.GpuVm;
     ...
     */
    public abstract class GpuPeProvisioner {
         ...
         * @post $none
         */
        public GpuPeProvisioner(double mips) {
            setMips(mips);
         ...
         * @post $none
         */
        public abstract boolean allocateMipsForVm(GpuVm vm, double mips);
         ...
         * classes.
         */
        public abstract boolean allocateMipsForVm(GpuVm vm, List<Double> mips);
         ...
         * @post $none
         */
        public abstract List<Double> getAllocatedMipsForVm(GpuVm vm);
         ...
         * @post $none
         */
        public abstract double getTotalAllocatedMipsForVm(GpuVm vm);
         ...
         * @post $none
         */
        public abstract double getAllocatedMipsForVmByVirtualPeId(GpuVm vm, int peId);
         ...
         * @post none
         */
        public abstract void deallocateMipsForVm(GpuVm vm);
