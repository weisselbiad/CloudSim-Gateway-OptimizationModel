...
import gpu.provisioners.GpuPeProvisioner;
    ...
    public class GpuPe {
        ...
        /** The pe provisioner. */
        private GpuPeProvisioner peProvisioner;
         ...
         * @post $none
         */
        public GpuPe(int id, GpuPeProvisioner peProvisioner) {
            setId(id);
         ...
         */
        protected void setPeProvisioner(GpuPeProvisioner peProvisioner) {
         ...
         */
        public GpuPeProvisioner getPeProvisioner() {
